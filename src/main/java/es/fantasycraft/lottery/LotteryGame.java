...
import es.fantasycraft.lottery.events.LotteryBuyTicketEvent;
import es.fantasycraft.lottery.events.LotteryDrawEvent;
...
public class LotteryGame
{
    ...
    public boolean addPlayer( final Player player, final int maxAmountOfTickets, final int numberOfTickets ) {
        ...
        if (lConfig.useEconomy() && plugin.hasEconomy()) {
            ...
            if (player.getInventory().contains(IDLibrary.getMaterial((int) (lConfig.getCost() * numberOfTickets)))) {
                {
                    // Remove items.
                    player.getInventory().removeItem(new ItemStack(IDLibrary.getMaterial(lConfig.getMaterial()), (int) (lConfig.getCost() * numberOfTickets)));
                }
            } else {
                return false;
            }
    ...
    public void removeFromClaimList( final Player player )
    {
        ...
        for ( String aClaimArray : claimArray )
        {
            ...
            player.getInventory().addItem( new ItemStack(IDLibrary.getMaterial(claimMaterial), claimAmount ) );
